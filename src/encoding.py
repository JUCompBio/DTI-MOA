...
model_dict = {
    ...
    "t5": {"model": T5EncoderModel, "model_args": ["Rostlab/prot_t5_xl_uniref50"], "model_kwargs": {"add_pooling_layer": False}, "tokenizer": T5Tokenizer, "tokenizer_args": ["Rostlab/prot_t5_xl_uniref50"], "tokenizer_kwargs": {"do_lower_case": False}, "data_indices": [0, -1], "type": "prot", "lib": "hf"},
